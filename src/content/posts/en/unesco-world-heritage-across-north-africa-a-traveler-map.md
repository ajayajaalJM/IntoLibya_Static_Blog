---
title: 'UNESCO Sites Across North Africa: A Traveler Map'
slug: unesco-world-heritage-across-north-africa-a-traveler-map
canonicalPath: /en/unesco-world-heritage-across-north-africa-a-traveler-map
lang: en
...
seo:
  title: 'UNESCO Sites Across North Africa: A Traveler Map | IntoLibya'
  description: 'UNESCO World Heritage across North Africa: a traveler map from Libya Roman sites to Tunisia, Egypt, and Sahara art zones.'
  canonical: https://intolibya.com/en/unesco-world-heritage-across-north-africa-a-traveler-map
---
...
<p>Cyrenaica sites such as <a href="/en/destination/shahat">Shahat</a> extend the map east when itineraries and access allow. Pair with coastal context at <a href="/en/destination/benghazi">Benghazi</a> region planning when tours include the east.</p>
