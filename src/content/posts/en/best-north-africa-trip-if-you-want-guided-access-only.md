...
canonicalPath: /en/best-north-africa-trip-if-you-want-guided-access-only
lang: en
...
seo:
  title: 'Best North Africa Trip If You Want Guided Access Only | IntoLibya'
  description: 'Best North Africa trip if you want guided access only: how Libya compares to Tunisia, Egypt, Morocco, and Algeria.'
  canonical: https://intolibya.com/en/best-north-africa-trip-if-you-want-guided-access-only
---
...
<li><a href="/en/algeria-sahara-dreams-what-libya-offers-instead">Algeria Sahara Dreams What Libya Offers Instead</a></li>
</ul>
